    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form action="{{ route('dashboard.Music.store') }}" method="post" enctype="multipart/form-data">
...
{{-- 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="likesNumber" step="1" class="form-control" value="{{ old('likesNumber') }}">
                    </div>
                    <div class="form-group">
                        <label>@lang('site.shareNumber')</label>
                        <input type="number" name="shareNumber" step="1" class="form-control" value="{{ old('shareNumber') }}">
                    </div>

                    <div class="form-group">
                        <label>@lang('site.Released')</label>
                        <input type="datetime-local" name="Released" class="form-control" value="{{ old('Released') }}">
                    </div>
                    ...
                    <div class="form-group">
                        <img src="{{ asset('uploads/Music_images/default.png') }}" style="width: 100px"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shareLink" class="form-control" value="{{ old('shareLink') }}">
                    </div>
